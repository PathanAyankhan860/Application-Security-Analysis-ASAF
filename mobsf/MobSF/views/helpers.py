...
class FileType(object):
    ...
    def is_apks(self):
        return (
            self.file_type in settings.APK_MIME
    ...
    def is_dylib(self):
        return (
            self.file_type in settings.IPA_MIME
    ...
    def is_zip(self):
        return (
            self.file_type in settings.ZIP_MIME
    ...
    def is_appx(self):
        return (
            self.file_type in settings.APPX_MIME
    ...
    def is_exe(self):
        ...
        EXE files are accepted based on their .exe extension.
        PE validation is performed later by the Windows
        static analyzer.
        """
        return self.file_name_lower.endswith('.exe')
